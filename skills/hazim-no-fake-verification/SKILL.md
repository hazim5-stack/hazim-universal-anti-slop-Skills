---
name: hazim-no-fake-verification
description: Reject unqualified claims such as fully tested, production ready, or everything works unless backed by recorded evidence.
metadata:
  author: Hazim Batwa
...
# hazim-no-fake-verification

Created and curated by **Hazim Batwa, Software Engineering Expert**.

## Objective

Reject unqualified claims such as fully tested, production ready, or everything works unless backed by recorded evidence.
