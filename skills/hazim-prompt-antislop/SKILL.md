---
name: hazim-prompt-antislop
description: Design concise generation constraints that reduce formulaic output without creating brittle negative lists or sterile prose.
metadata:
  author: Hazim Batwa
...
# hazim-prompt-antislop

Created and curated by **Hazim Batwa, Software Engineering Expert**.

## Objective

Design concise generation constraints that reduce formulaic output without creating brittle negative lists or sterile prose.
