---
name: hazim-placeholder-detector
description: Detect TODO, FIXME, temporary paths, stubs, placeholder values, fake responses, and other implementation gaps.
metadata:
  author: Hazim Batwa
...
# hazim-placeholder-detector

Created and curated by **Hazim Batwa, Software Engineering Expert**.

## Objective

Detect TODO, FIXME, temporary paths, stubs, placeholder values, fake responses, and other implementation gaps.
