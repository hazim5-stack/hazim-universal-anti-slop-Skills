---
name: hazim-error-handling
description: Audit error propagation, silent catches, misleading fallbacks, retry behavior, user feedback, and false success states.
metadata:
  author: Hazim Batwa
...
# hazim-error-handling

Created and curated by **Hazim Batwa, Software Engineering Expert**.

## Objective

Audit error propagation, silent catches, misleading fallbacks, retry behavior, user feedback, and false success states.
