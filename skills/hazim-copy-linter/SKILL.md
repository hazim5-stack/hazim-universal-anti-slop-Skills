---
name: hazim-copy-linter
description: Run deterministic prose checks with stable rule identifiers, suppressions, severity levels, and machine-readable output.
metadata:
  author: Hazim Batwa
...
Run deterministic prose checks with stable rule identifiers, suppressions, severity levels, and machine-readable output.
