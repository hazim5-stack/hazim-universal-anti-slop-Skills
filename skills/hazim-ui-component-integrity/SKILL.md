---
name: hazim-ui-component-integrity
description: Verify that interface components include meaningful states, feedback, validation, and interaction behavior rather than presentation-only shells.
metadata:
  author: Hazim Batwa
...
# hazim-ui-component-integrity

Created and curated by **Hazim Batwa, Software Engineering Expert**.

## Objective

Verify that interface components include meaningful states, feedback, validation, and interaction behavior rather than presentation-only shells.
...
- Identify product-specific visual intent.
- Name generic patterns without automatic conviction.
- Inspect all component states.
