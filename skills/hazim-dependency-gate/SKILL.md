---
name: hazim-dependency-gate
description: Evaluate necessity, overlap, maintenance, size, license, security, and operational cost before adding a dependency.
metadata:
  author: Hazim Batwa
...
# hazim-dependency-gate

Created and curated by **Hazim Batwa, Software Engineering Expert**.

## Objective

Evaluate necessity, overlap, maintenance, size, license, security, and operational cost before adding a dependency.
