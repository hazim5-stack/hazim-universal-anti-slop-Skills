---
name: hazim-antislop-repair
description: Repair approved anti-slop findings while preserving behavior, meaning, scope, and existing user work. Use after findings have been selected for correction.
metadata:
  author: Hazim Batwa
...
# hazim-antislop-repair

Created and curated by **Hazim Batwa, Software Engineering Expert**.

## Objective

Repair approved anti-slop findings while preserving behavior, meaning, scope, and existing user work. Use after findings have been selected for correction.
