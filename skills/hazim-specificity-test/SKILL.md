---
name: hazim-specificity-test
description: Test whether a claim contains product-specific names, constraints, observations, measurements, dates, locations, or examples.
metadata:
  author: Hazim Batwa
...
# hazim-specificity-test

Created and curated by **Hazim Batwa, Software Engineering Expert**.

## Objective

Test whether a claim contains product-specific names, constraints, observations, measurements, dates, locations, or examples.
