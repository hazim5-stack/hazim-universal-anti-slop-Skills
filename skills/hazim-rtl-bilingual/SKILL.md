---
name: hazim-rtl-bilingual
description: Audit Arabic-English interfaces for directionality, mixed text, numerals, punctuation, icons, tables, alignment, and semantic mirroring.
metadata:
  author: Hazim Batwa
...
Audit Arabic-English interfaces for directionality, mixed text, numerals, punctuation, icons, tables, alignment, and semantic mirroring.
...
- Inspect intermediate viewport widths.
- Verify semantics and announcements.
- Check RTL and mixed-direction content.
