---
name: hazim-operational-readiness
description: Review migrations, configuration, rollback, monitoring, logging, limits, backups, health checks, and production deployment assumptions.
metadata:
  author: Hazim Batwa
...
# hazim-operational-readiness

Created and curated by **Hazim Batwa, Software Engineering Expert**.

## Objective

Review migrations, configuration, rollback, monitoring, logging, limits, backups, health checks, and production deployment assumptions.
