---
name: hazim-test-quality
description: Detect empty assertions, always-passing tests, mock-only coverage, low-value snapshots, mismatched names, and missing failure paths.
metadata:
  author: Hazim Batwa
...
Detect empty assertions, always-passing tests, mock-only coverage, low-value snapshots, mismatched names, and missing failure paths.
