---
name: hazim-architecture-antislop
description: Detect speculative layers, single-use abstractions, premature services, configuration theater, and architecture without current consumers.
metadata:
  author: Hazim Batwa
...
# hazim-architecture-antislop

Created and curated by **Hazim Batwa, Software Engineering Expert**.

## Objective

Detect speculative layers, single-use abstractions, premature services, configuration theater, and architecture without current consumers.
