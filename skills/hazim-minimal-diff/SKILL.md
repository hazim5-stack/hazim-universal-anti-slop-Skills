---
name: hazim-minimal-diff
description: Produce the smallest complete change that satisfies the request while preserving unrelated files and user modifications.
metadata:
  author: Hazim Batwa
...
Produce the smallest complete change that satisfies the request while preserving unrelated files and user modifications.
