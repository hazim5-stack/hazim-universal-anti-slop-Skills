---
name: hazim-form-antislop
description: Audit forms for unnecessary fields, weak validation, data loss, poor autofill, inaccessible errors, and unsuitable input behavior.
metadata:
  author: Hazim Batwa
...
Audit forms for unnecessary fields, weak validation, data loss, poor autofill, inaccessible errors, and unsuitable input behavior.
