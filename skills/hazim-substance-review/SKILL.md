---
name: hazim-substance-review
description: Review prose, documentation, code comments, or product claims for concrete meaning, specificity, evidence, and decision value.
metadata:
  author: Hazim Batwa
...
# hazim-substance-review

Created and curated by **Hazim Batwa, Software Engineering Expert**.

## Objective

Review prose, documentation, code comments, or product claims for concrete meaning, specificity, evidence, and decision value.
