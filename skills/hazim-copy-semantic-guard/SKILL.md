---
name: hazim-copy-semantic-guard
description: Compare source and revision to detect invented facts, strengthened claims, removed caveats, false causality, and changed meaning.
metadata:
  author: Hazim Batwa
...
# hazim-copy-semantic-guard

Created and curated by **Hazim Batwa, Software Engineering Expert**.

## Objective

Compare source and revision to detect invented facts, strengthened claims, removed caveats, false causality, and changed meaning.
