---
name: hazim-voice-protection
description: Create and apply a protect list for signature vocabulary, rhythm, humor, stance, formality, dialect, and brand constraints.
metadata:
  author: Hazim Batwa
...
# hazim-voice-protection

Created and curated by **Hazim Batwa, Software Engineering Expert**.

## Objective

Create and apply a protect list for signature vocabulary, rhythm, humor, stance, formality, dialect, and brand constraints.
