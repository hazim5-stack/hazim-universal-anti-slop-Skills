---
name: hazim-ui-screenshot-audit
description: Inspect screenshots for hierarchy, identity, accessibility, template residue, decorative noise, and product-specific visual meaning.
metadata:
  author: Hazim Batwa
...
# hazim-ui-screenshot-audit

Created and curated by **Hazim Batwa, Software Engineering Expert**.

## Objective

Inspect screenshots for hierarchy, identity, accessibility, template residue, decorative noise, and product-specific visual meaning.
