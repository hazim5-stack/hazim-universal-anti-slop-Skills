---
name: hazim-antislop-delivery-gate
description: Issue PASS, PASS WITH WARNINGS, FAIL, or NOT VERIFIED from observable evidence. Use immediately before a deliverable, release, or handoff.
metadata:
  author: Hazim Batwa
...
# hazim-antislop-delivery-gate

Created and curated by **Hazim Batwa, Software Engineering Expert**.

## Objective

Issue PASS, PASS WITH WARNINGS, FAIL, or NOT VERIFIED from observable evidence. Use immediately before a deliverable, release, or handoff.
