---
name: hazim-antislop-audit
description: Run a cross-domain anti-slop audit with separate severity, confidence, evidence, and remediation fields. Use for broad reviews without modifying files.
metadata:
  author: Hazim Batwa
...
# hazim-antislop-audit

Created and curated by **Hazim Batwa, Software Engineering Expert**.

## Objective

Run a cross-domain anti-slop audit with separate severity, confidence, evidence, and remediation fields. Use for broad reviews without modifying files.
