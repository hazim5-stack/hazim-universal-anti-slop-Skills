---
name: hazim-comments-docstrings
description: Remove comments that restate code while preserving rationale, constraints, contracts, workarounds, and safety context.
metadata:
  author: Hazim Batwa
...
# hazim-comments-docstrings

Created and curated by **Hazim Batwa, Software Engineering Expert**.

## Objective

Remove comments that restate code while preserving rationale, constraints, contracts, workarounds, and safety context.
