---
name: hazim-user-flow-review
description: Review an end-to-end user journey including entry, onboarding, primary task, failure recovery, completion, and exit.
metadata:
  author: Hazim Batwa
...
# hazim-user-flow-review

Created and curated by **Hazim Batwa, Software Engineering Expert**.

## Objective

Review an end-to-end user journey including entry, onboarding, primary task, failure recovery, completion, and exit.
