---
name: hazim-ui-originality
description: Test whether a visual system is specific to its product, audience, and content rather than transferable unchanged to an unrelated product.
metadata:
  author: Hazim Batwa
...
# hazim-ui-originality

Created and curated by **Hazim Batwa, Software Engineering Expert**.

## Objective

Test whether a visual system is specific to its product, audience, and content rather than transferable unchanged to an unrelated product.
