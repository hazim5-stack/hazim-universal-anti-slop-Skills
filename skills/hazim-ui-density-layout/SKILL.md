---
name: hazim-ui-density-layout
description: Review hierarchy, density, spacing, alignment, containers, columns, and information balance across interface layouts.
metadata:
  author: Hazim Batwa
...
# hazim-ui-density-layout

Created and curated by **Hazim Batwa, Software Engineering Expert**.

## Objective

Review hierarchy, density, spacing, alignment, containers, columns, and information balance across interface layouts.
