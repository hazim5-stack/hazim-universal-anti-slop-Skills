---
name: hazim-generation-evaluator
description: Compare outputs across specificity, substance, accuracy, voice, rhythm, originality, completeness, and safety as separate dimensions.
metadata:
  author: Hazim Batwa
...
# hazim-generation-evaluator

Created and curated by **Hazim Batwa, Software Engineering Expert**.

## Objective

Compare outputs across specificity, substance, accuracy, voice, rhythm, originality, completeness, and safety as separate dimensions.
