---
name: hazim-attribution-check
description: Resolve citations, statistics, quotations, studies, package claims, and links to evidence that supports the precise assertion.
metadata:
  author: Hazim Batwa
...
# hazim-attribution-check

Created and curated by **Hazim Batwa, Software Engineering Expert**.

## Objective

Resolve citations, statistics, quotations, studies, package claims, and links to evidence that supports the precise assertion.
