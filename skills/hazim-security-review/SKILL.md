---
name: hazim-security-review
description: Perform a change-scoped security review covering authorization, injection, SSRF, XSS, CSRF, secrets, unsafe files, redirects, and defaults.
metadata:
  author: Hazim Batwa
...
# hazim-security-review

Created and curated by **Hazim Batwa, Software Engineering Expert**.

## Objective

Perform a change-scoped security review covering authorization, injection, SSRF, XSS, CSRF, secrets, unsafe files, redirects, and defaults.
