---
name: hazim-mobile-layout
description: Audit responsive reflow, intermediate widths, touch targets, software keyboards, safe areas, overflow, and hover-only behavior.
metadata:
  author: Hazim Batwa
...
Audit responsive reflow, intermediate widths, touch targets, software keyboards, safe areas, overflow, and hover-only behavior.
