---
name: hazim-ux-antislop
description: Audit user experience for unclear goals, ornamental features, empty dashboards, ambiguous actions, and template-driven flows.
metadata:
  author: Hazim Batwa
...
Audit user experience for unclear goals, ornamental features, empty dashboards, ambiguous actions, and template-driven flows.
