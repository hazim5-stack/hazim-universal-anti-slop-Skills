---
name: hazim-product-reality-check
description: Detect product theater such as fake live states, invented metrics, unconnected controls, placeholder dashboards, and unsupported claims.
metadata:
  author: Hazim Batwa
...
# hazim-product-reality-check

Created and curated by **Hazim Batwa, Software Engineering Expert**.

## Objective

Detect product theater such as fake live states, invented metrics, unconnected controls, placeholder dashboards, and unsupported claims.
...
- Trace the primary user task.
- Exercise failure and recovery paths.
- Reject fake or disconnected states.
- Confirm visible promises match behavior.
