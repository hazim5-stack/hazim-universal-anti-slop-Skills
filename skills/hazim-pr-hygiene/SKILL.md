---
name: hazim-pr-hygiene
description: Review pull-request scope, description accuracy, debug residue, migrations, breaking changes, and test evidence.
metadata:
  author: Hazim Batwa
...
Review pull-request scope, description accuracy, debug residue, migrations, breaking changes, and test evidence.
